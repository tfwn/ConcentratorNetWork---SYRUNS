...
/*These Bitband Macro Definiations are added by Jason at Sep 15, 2009*/
#define GPIOA_OUTPUT_Pin(Num)    *((vu8 *)((GPIOA_BASE + 12 - 0x40000000)*32 + 0x42000000 + 4*Num)) 
#define GPIOA_INPUT_Pin(Num)     *((vu8 *)((GPIOA_BASE + 8 - 0x40000000)*32 + 0x42000000 + 4*Num))

#define GPIOB_OUTPUT_Pin(Num)    *((vu8 *)((GPIOB_BASE + 12 - 0x40000000)*32 + 0x42000000 + 4*Num))
#define GPIOB_INPUT_Pin(Num)     *((vu8 *)((GPIOB_BASE + 8 - 0x40000000)*32 + 0x42000000 + 4*Num))

#define GPIOC_OUTPUT_Pin(Num)    *((vu8 *)((GPIOC_BASE + 12 - 0x40000000)*32 + 0x42000000 + 4*Num))
#define GPIOC_INPUT_Pin(Num)     *((vu8 *)((GPIOC_BASE + 8 - 0x40000000)*32 + 0x42000000 + 4*Num))

#define GPIOD_OUTPUT_Pin(Num)    *((vu8 *)((GPIOD_BASE + 12 - 0x40000000)*32 + 0x42000000 + 4*Num))
#define GPIOD_INPUT_Pin(Num)     *((vu8 *)((GPIOD_BASE + 8 - 0x40000000)*32 + 0x42000000 + 4*Num))

#define GPIOE_OUTPUT_Pin(Num)    *((vu8 *)((GPIOE_BASE + 12 - 0x40000000)*32 + 0x42000000 + 4*Num))
#define GPIOE_INPUT_Pin(Num)     *((vu8 *)((GPIOE_BASE + 8 - 0x40000000)*32 + 0x42000000 + 4*Num))

#define GPIOF_OUTPUT_Pin(Num)    *((vu8 *)((GPIOF_BASE + 12 - 0x40000000)*32 + 0x42000000 + 4*Num))
#define GPIOF_INPUT_Pin(Num)     *((vu8 *)((GPIOF_BASE + 8 - 0x40000000)*32 + 0x42000000 + 4*Num))

#define GPIOG_OUTPUT_Pin(Num)    *((vu8 *)((GPIOG_BASE + 12 - 0x40000000)*32 + 0x42000000 + 4*Num))
#define GPIOG_INPUT_Pin(Num)     *((vu8 *)((GPIOG_BASE + 8 - 0x40000000)*32 + 0x42000000 + 4*Num))
/*End These Bitband Macro Definiations */
