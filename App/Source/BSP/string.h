...
_C_STD_BEGIN
  ...
  #define NULL  _NULL
                ...
                /* declarations */
_C_LIB_DECL
__ATTRIBUTES int memcmp(const void *, const void *, size_t);
__ATTRIBUTES void * memcpy(void *, const void *, size_t);
__ATTRIBUTES void * memmove(void *, const void *, size_t);
__ATTRIBUTES void * memset(void *, int, size_t);
__ATTRIBUTES char * strcat(char *, const char *);
__ATTRIBUTES int strcmp(const char *, const char *);
__ATTRIBUTES int strcoll(const char *, const char *);
__ATTRIBUTES char * strcpy(char *, const char *);
__ATTRIBUTES size_t strcspn(const char *, const char *);
__ATTRIBUTES char * strerror(int);
__ATTRIBUTES size_t strlen(const char *);
__ATTRIBUTES char * strncat(char *, const char *, size_t);
__ATTRIBUTES int strncmp(const char *, const char *, size_t);
__ATTRIBUTES char * strncpy(char *, const char *, size_t);
__ATTRIBUTES size_t strspn(const char *, const char *);
__ATTRIBUTES char * strtok(char *, const char *);
__ATTRIBUTES size_t strxfrm(char *, const char *, size_t);
_END_C_LIB_DECL

#ifdef __cplusplus
  __ATTRIBUTES const void *memchr(const void *_S, int _C, size_t _N);
  __ATTRIBUTES const char *strchr(const char *_S, int _C);
  __ATTRIBUTES const char *strpbrk(const char *_S, const char *_P);
  __ATTRIBUTES const char *strrchr(const char *_S, int _C);
  __ATTRIBUTES const char *strstr(const char *_S, const char *_P);
  __ATTRIBUTES void *memchr(void *_S, int _C, size_t _N);
  __ATTRIBUTES char *strchr(char *_S, int _C);
  __ATTRIBUTES char *strpbrk(char *_S, const char *_P);
  __ATTRIBUTES char *strrchr(char *_S, int _C);
  __ATTRIBUTES char *strstr(char *_S, const char *_P);
#else /* !__cplusplus */
  __ATTRIBUTES void *memchr(const void *_S, int _C, size_t _N);
  __ATTRIBUTES char *strchr(const char *_S, int _C);
  __ATTRIBUTES char *strpbrk(const char *_S, const char *_P);
  __ATTRIBUTES char *strrchr(const char *_S, int _C);
  __ATTRIBUTES char *strstr(const char *_S, const char *_P);
#endif /* __cplusplus */
...
#include <DLib_Product_string.h>
  ...
  _STD_BEGIN
                ...
                /* The implementations. */
_C_LIB_DECL
__ATTRIBUTES void *__iar_Memchr(const void *, int, size_t);
__ATTRIBUTES char *__iar_Strchr(const char *, int);
__ATTRIBUTES char *__iar_Strerror(int, char *);
__ATTRIBUTES char *__iar_Strpbrk(const char *, const char *);
__ATTRIBUTES char *__iar_Strrchr(const char *, int);
__ATTRIBUTES char *__iar_Strstr(const char *, const char *);
_END_C_LIB_DECL
