...
//    PUBLIC  OS_CPU_PendSVHandler				; Commented out and add next line by zhangxp for uCos-II
...
;OS_CPU_PendSVHandler							; Commented out and add next line by zhangxp for uCos-II
PendSV_Handler
