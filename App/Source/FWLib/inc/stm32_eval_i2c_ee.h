...
/* Includes ------------------------------------------------------------------*/
//#include "stm32_eval.h"              20110505 ×¢ÊÍµô
#include "stm32f10x.h"
...
#define USE_DEFAULT_CRITICAL_CALLBACK                                           //20110505 ×¢ÊÍµô
...
/* Uncomment the following line to use the default sEE_TIMEOUT_UserCallback() 
   ...
   errors, busy devices ...). */   
#define USE_DEFAULT_TIMEOUT_CALLBACK                                            //20110505È¡Ïû×¢ÊÍ
...
#define I2C_SLAVE_ADDRESS7      0xA4
...
void     EE_DeInit(void);
void     EE_Init(void);
uint32_t EE_ReadBuffer(uint8_t devAddr,uint8_t* pBuffer, uint16_t ReadAddr, uint16_t* NumByteToRead);
...
void     I2C_configuration(void);                                               //20110508 Ôö¼Ó
